...
const CreatePost = () => {
  ...
  return (
    <div className="bg-white rounded-md shadow-md text-gray-500 p-2">
      ...
      {imageToPost && (
        <div className="flex items-center px-4 py-2 space-x-2 filter hover:brightness-210 transition duration-150">
          <Image src={imageToPost} width={40} height={40} objectFit="contain" />
        </div>
      )}
