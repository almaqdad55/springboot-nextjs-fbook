...
import { postModalState } from '../public/src/features/postModalSlice';

const PopupModal = () => {
  const {
    data: { user },
  } = useSession();
  console.log('postModalState', postModalState);
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex flex-col">
              <div className="rounded-md p-4">
                ...
                <form action="" className="flex flex-1 mt-3">
                  <textarea
                    className=" min-h-[200px] focus:outline-none flex-grow bg-gray-100 px-4 font-xl 
                    hover:bg-gray-200"
                    type="text"
                    ref={inputRef}
