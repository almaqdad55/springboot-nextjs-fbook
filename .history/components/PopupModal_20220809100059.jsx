        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            >
              ...
              <button
                className="p-4 ml-auto bg-transparent border-0   float-right text-3xl leading-none font-semibold outline-none focus:outline-none bg-gray-100"
                onClick={() => setShowModal(false)}
              >
                <span className="bg-white text-gray-500  h-6 w-6 text-2xl block outline-none focus:outline-none">
                  X
                </span>
              </button>
            </div>
